...
```json
{
  ...
  "analysis": {
    ...
    "offer_score": 7,
    "trust_score": 6,
    "sales_argument_score": 6,
    "automation_depth": 3,
    "market_positioning": "Корпоративное B2B-позиционирование с акцентом на надёжность",
    "recommendations": [
...
```typescript
{
  ...
  offer_score: number           // Оценка коммерческого предложения (0-10)
  trust_score: number           // Оценка доверия / социальных доказательств (0-10)
  sales_argument_score: number // Оценка аргументации продаж (0-10)
  automation_depth: number     // Глубина автоматизации / автопродаж (0-10)
  market_positioning: string   // Позиционирование на рынке
  recommendations: string[]     // Рекомендации
}
```
